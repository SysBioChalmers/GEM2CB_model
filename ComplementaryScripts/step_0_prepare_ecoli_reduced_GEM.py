...
ecoli_reduced_model.reactions.get_by_id('EX_GLU').bounds = (-10.0,0.0)
ecoli_reduced_model.objective = 'EX_B'
ecoli_reduced_model.optimize()

cobra.io.save_json_model(ecoli_reduced_model,'../ComplementaryData/ecoli_reduced_model.json')
ecoli_reduced_model2 = cobra.io.load_json_model('../ComplementaryData/ecoli_reduced_model.json')
cobra.io.write_sbml_model(ecoli_reduced_model2,'../ComplementaryData/ecoli_reduced_model.xml')