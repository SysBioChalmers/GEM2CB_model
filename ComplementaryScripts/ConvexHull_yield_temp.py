...
while len(hull_cutoff_index_set) < ndim+1:
...
# data_index = []
# C=points[hull_cutoff_index,data_index].T
...
if hull.ndim ==2:
    ...
    hull_cutoff = ConvexHull(hull_cutoff_points,qhull_options='Qt QJ Pp Qw Qx')
    for simplex in hull_cutoff.simplices:
         plt.plot(hull_cutoff_points[simplex, 0], hull_cutoff_points[simplex, 1],hull_cutoff_points1[simplex, 2], 'r-.')
