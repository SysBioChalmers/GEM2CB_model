...
BH_experimet_data['B.h'] = BH_experimet_data['B.h']  # unites

### yield of experiment data
data_cloum_name = ['fru', 'R.i', 'F.p', 'B.h', 'ac', 'for', 'but', 'lac']
experiment_data_df_trimed = BH_experimet_data[['fru', 'B.h', 'ac']]
...
final_yield_row_index = [-1, -2, -3, -4, -5, -6]  # stable yield range
...
print(coefficient == 22.157199166964784)
coefficient = 22.157199166964784
...
# for next step!!  array([0.35922466, 0.29067222])
