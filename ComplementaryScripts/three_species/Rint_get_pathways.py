...
RI_experimet_data['R.i'] = RI_experimet_data['R.i']  # unites

### yield of experiment data
data_cloum_name = ['fru', 'R.i', 'F.p', 'B.h', 'ac', 'for', 'but', 'lac']
experiment_data_df_trimed = RI_experimet_data[['fru', 'R.i', 'for', 'but', ]]
...
final_yield_row_index = [11, 12, 13, 14]  # stable yield range
...
coefficient = 16.510575109772166
...
hull_cutoff_index_99 = [0, 1, 2, 4, 6, 8, 10, 14, 16]
hull_active_index = our_indexes[-1][-1]
hull_active_index = [1, 4, 14]
# weights =	 [0.       0.406545 0.       0.119731 0.       0.       0.       0.473724
#  0.      ]
